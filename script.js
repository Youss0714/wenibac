            ...
            content: `
                <div style="padding: 15px; font-family: Inter, sans-serif; max-width: 250px;">
                    ...
                    <div style="margin: 8px 0; color: #374151; font-size: 13px;">
                        ...
                        <p style="margin: 2px 0;"><i class="fas fa-envelope" style="color: #3b82f6; width: 16px;"></i> oudrao@yahoo.com</p>
                    </div>
...
function openWhatsApp(message = '') {
    const phone = '233265193893'; // Updated with correct WhatsApp number
